...
main_path          = 'D:\\R\\AirOnTimeParquetPyArrow'
...
main_path_partitioned         = os.path.join('D:\\', 'R', 'AirOnTimeParquetPartitionedPyArrow')
flights_1999_2000_partitioned = ds.dataset(
    source       = main_path_partitioned,
    format       = 'parquet',
    partitioning = 'hive'
    )
