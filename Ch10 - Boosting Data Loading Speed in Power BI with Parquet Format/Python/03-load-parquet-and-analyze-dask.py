...
main_path = 'D:\\R\\AirOnTimeParquetDask'
...
flights_1999_2000 = dd.read_parquet(
...
main_path_partitioned = os.path.join('D:\\', 'R', 'AirOnTimeParquetPartitionedDask')

filters = [
    ("YEAR", "in", [1999, 2000])
]

flights_1999_2000_partitioned_ddf = dd.read_parquet(
    path    = os.path.join(main_path_partitioned, '**'),
    index   = 'YEAR',
    filters = filters
    )
