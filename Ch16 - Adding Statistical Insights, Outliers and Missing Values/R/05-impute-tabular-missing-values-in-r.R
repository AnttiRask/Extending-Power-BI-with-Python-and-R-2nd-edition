...
# Function to calculate the matrix correlation of a numeric dataframe also 
# imputing missing values with MICE in a dataframe
...
corr_tbl <- corr_impute_missing_values(
    tbl_cleaned,
    variables = numeric_col_idxs,
    method    = 'pearson'
)
