...
# Let's plot sulphates boxplot in order to see if there are univariate outliers
...
# Let's now plot boxplots for each quality vote, removing the initial outliers
...
#-----------------------
# Let's now plot an histogram for all the variables using the dataset without outliers
...
# Let's plot an histogram for all the transformed variables in order to check if skewness is decreased 
...
# Calculate the probability that the distance D[5] is an outlier
