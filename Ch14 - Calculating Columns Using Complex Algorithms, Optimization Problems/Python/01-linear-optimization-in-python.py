...
main_path = 'C:/R/Extending-Power-BI-with-Python-and-R-2nd-edition/Ch14 - Calculating Columns Using Complex Algorithms, Optimization Problems'

warehouse_supply_df = pd.read_excel(
    os.path.join(main_path,'RetailData.xlsx'),
...
country_demands_df = pd.read_excel(
    os.path.join(main_path,'RetailData.xlsx'),
...
decision_vars = plp.LpVariable.matrix(
    ...
    indices  = var_indexes, # variable indexes
...
# Check the product quantities shipped from warehouses to countries in a clear way
