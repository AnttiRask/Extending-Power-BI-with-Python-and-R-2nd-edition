...
# # Uncomment this code if you're not using it in Power BI in order to load the imputed test dataset
...
with open(os.path.join(main_path, "titanic-model-flaml.pkl"), 'rb') as f:
    model = pickle.load(f)
