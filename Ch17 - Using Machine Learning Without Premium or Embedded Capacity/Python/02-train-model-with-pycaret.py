...
# Get the model that performs better in the cross-validation phase. Use verbose=True to get all the metrics as output in VS Code.
best_model = compare_models(verbose=True)

# Save the model in a pkl file for future reuse
save_model(best_model, "C:/R/Extending-Power-BI-with-Python-and-R-2nd-edition/Ch17 - Using Machine Learning Without Premium or Embedded Capacity/titanic-model")
