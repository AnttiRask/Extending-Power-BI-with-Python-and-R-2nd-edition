...
# Uncomment this if not using the code in Power BI, as the imputed dataset will be used in the training code
df_imputed.to_csv(
    "C:/R/Extending-Power-BI-with-Python-and-R-2nd-edition/Ch17 - Using Machine Learning Without Premium or Embedded Capacity/titanic-imputed.csv",
    index=False
)
