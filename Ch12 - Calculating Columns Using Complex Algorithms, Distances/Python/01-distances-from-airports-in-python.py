...
hotels_df = pd.read_excel('C:/R/Extending-Power-BI-with-Python-and-R-2nd-edition/Ch12 - Calculating Columns Using Complex Algorithms, Distances/hotels-ny.xlsx', engine = 'openpyxl')
hotels_df.head()
