...
# You can also show the distribution of a third dimension (in this case Survived) coloring half violin plot
violinPlot(data=df, varx='Pclass', vary='Age', hue='Survived',
           title='Passenger age VS Passenger class',
           xlab='Pclass', ylab='Age')
plt.show()

# Let's calculate the correlation ratio between the categorical variable Pclass and the numeric one Age
